...
int main(int argc, char *argv[]) {
    ...
    try {
        ...
        std::vector< vec4 > mandelPixels_Host;
        mandelPixels_Host.resize( numPixels );
        vec4*   pMandel = mandelPixels_Host.data();
...

        {
            ...
            q.submit([&](sycl::handler& h) {
                ...
                sycl::accessor mandelPixels_Accessor( mandelPixels_Device, h, sycl::write_only, sycl::no_init );
                ...
                h.parallel_for(
                    ...
                    [=](auto gid) { 
                        ...
                        mandelPixels_Accessor[ addr ] = vec4{ fiter, fiter, fiter, fiter };
                    }                        
                );
        ...
        FILE *file;
        int err = fileopen(&file, "sycl-mandelbrot-buffer.ppm");
        fprintf(file, "P3\n");
